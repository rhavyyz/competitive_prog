...
/*
    ...
    One cool trick about this mobius inversion stuff is:
    
    What results the convolution of 1 bar and μ.

    The awnser is, the identity term of this group that has the operation of the Dirichet convolution.

    This identity term is a sequence of form:

    ε => 1 0 0 0 0 0 ...
         ^         ^  
         |         |
    Only 1   Infinity sequence of 0`s



    Essa funcao tem cara
